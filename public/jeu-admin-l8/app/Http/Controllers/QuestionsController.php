...
class QuestionsController extends Controller
{
    ...
    public function questionstest(Request $request)
    {
        ...
        return view('question.questions',['questions'=>$questions, 'titre'=>$titre, 'categories'=>$categories, 'niveaux'=>$niveaux, 'categorie_id_selected'=>$categorie_id_selected, 'niveau_id_selected'=>$niveau_id_selected, ]);
